...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/hidden-butterfly-789e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/hidden-butterfly-789e
```

A live public deployment of this template is available at [https://hidden-butterfly-789e.templates.workers.dev](https://hidden-butterfly-789e.templates.workers.dev)
